...
function eval_lm_tamp {
    ...
    CMD="python scripts/eval/eval_lm_real_world.py ${args}"
...
function run_planners {
    for planner in "${PLANNERS[@]}"; do
        ...
        POLICY_CHECKPOINTS=(
            ...
            # "models/20230309/policy/pick/final_model/final_model.pt"
            # "models/20230309/policy/place/final_model/final_model.pt"
            # "models/20230309/policy/pull/final_model/final_model.pt"
            # "models/20230309/policy/push/final_model/final_model.pt"
            # "models/20230125/policy/pick/final_model/final_model.pt"
...
input_path="models"
output_path="plots"
exp_name="20230313/hierarchical"
...
for task_num in "${TASK_NUMS[@]}"; do
    ENV_CONFIG="configs/pybullet/envs/t2m/${real_or_sim}/tasks/task${task_num}.yaml"
    PDDL_DOMAIN="configs/pybullet/envs/t2m/${real_or_sim}/tasks/symbolic_domain.pddl"
    PDDL_PROBLEM="configs/pybullet/envs/t2m/${real_or_sim}/tasks/task${task_num}_symbolic.pddl"
