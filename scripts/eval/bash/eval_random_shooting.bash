...
python scripts/eval/sweep_pybox2d.py \
    --exec-config configs/pybox2d/exec/placeright2d_pushleft2dcontrol/random_shooting.yaml \
    --sweep-config configs/pybox2d/exec/placeright2d_pushleft2dcontrol/sweeps/random_shooting.json \
    --checkpoints \
