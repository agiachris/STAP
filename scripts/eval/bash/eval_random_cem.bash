...
#     --exec-config configs/pybox2d/exec/placeright2d_pushleft2dcontrol/random_cem.yaml \
#     --sweep-config configs/pybox2d/exec/placeright2d_pushleft2dcontrol/sweeps/random_cem.json \
#     --checkpoints \
