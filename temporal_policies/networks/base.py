...
class ActorCriticPolicy(nn.Module):
    ...
    def __init__(self, observation_space, action_space, 
        ...
        super().__init__()
        encoder_class = vars(temporal_policies.networks)[encoder_class] if isinstance(encoder_class, str) else encoder_class
        actor_class = vars(temporal_policies.networks)[actor_class] if isinstance(actor_class, str) else actor_class
        critic_class = vars(temporal_policies.networks)[critic_class] if isinstance(critic_class, str) else critic_class
